        ...
        return (
            (function () {
                ...
                var s = {
                    ...
                    success: function (e) {
                        if (e.previewElement){ 
                            ...
                            sendRestRequest(this.options.responseURL);
                            //alert(this.options.responseURL);
                ...
                function sendRestRequest(name) {
                    var imageKey = name;
                    var restUrl = _config.api.pollerInvokeUrl;
                ...
                function createWsConnection(data) {
                    var wsUrl =_config.api.wsInvokeUrl;
                    if (wsUrl == "" || wsUrl == null) {
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        var self = this;
                                        setTimeout(function () {
                                            if (self.options.testing <1){
                                                $.ajax({
                                                    url: '/uploadimage',
                                                    headers: { "X-CSRF-Token" : document.getElementById('csrfToken').value  },
                                                    data: {
                                                        'originalImageholder': e.dataURL
                                                    },
                                                    type: 'POST',
                                                    success: function(response) {
                                                        self.options.responseURL = response;
                                                        return self.processFiles([e]);
                                                    },
