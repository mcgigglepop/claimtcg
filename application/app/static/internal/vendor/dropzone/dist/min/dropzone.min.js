            ...
            (function () {
                ...
                var s = {
                    ...
                    addedfile: function (e) {
                        ...
                        if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews) && this.options.testing < 1) {
                    ...
                    removedfile: function (e) {
                        ...
                        for (let i = 0; i < this.options.originalImageholder.length; i++) {
                            if(this.options.originalImageholder[i].name == e.name){
                                this.options.originalImageholder.splice(i, 1);
                            }
                        }
                    ...
                    complete: function (e) {
                        if ((e._removeLink && (e._removeLink.innerHTML = this.options.dictRemoveFile), e.previewElement)){
                            ...
                            document.getElementById("checkcomplete").style.display = "none";
                            document.getElementById("statusLoader").style.display = "inline-block";
                            //sendRestRequest(e.name);
                ...
                function sendRestRequest(name) {
                    var imageKey = name;
                    restUrl = _config.api.pollerInvokeUrl
                                            ...
                                            (s.onload = function () {
                                                ...
                                                return (
                                                    ...
                                                    a(function (i) {
                                                        ...
                                                        if(u.options.testing<1){
                                                            u.options.originalImageholder.push(item);
                                                        }
                                                        
                                                        console.log(u.options.originalImageholder);
