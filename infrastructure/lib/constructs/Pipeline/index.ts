...
export class PipelineStack extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.backEndTestProject = new PipelineProject(
      scope,
      `Infrastructure-BackEndTest-PipelineProject-${props.environment}`,
      {
        projectName: `Infrastructure-BackEndTest-PipelineProject-${props.environment}`,
        environment: {
    ...
    this.deployProject = new PipelineProject(
      this,
      `Infrastructure-BackEndBuild-PipelineProject-${props.environment}`,
      {
        projectName: `Infrastructure-BackEndBuild-PipelineProject-${props.environment}`,
        environment: {
          privileged: true,
          buildImage: LinuxBuildImage.fromCodeBuildImageId(
            'aws/codebuild/amazonlinux2-x86_64-standard:4.0',
    ...
    this.frontEndTestProject = new PipelineProject(
      scope,
      `Infrastructure-FrontEndTest-PipelineProject-${props.environment}`,
      {
        projectName: `Infrastructure-FrontEndTest-PipelineProject-${props.environment}`,
        environment: {
          buildImage: LinuxBuildImage.fromCodeBuildImageId(
            'aws/codebuild/amazonlinux2-x86_64-standard:4.0',
          ),
    ...
    this.pipeline = new Pipeline(scope, `Pipeline-${props.environment}`, {
      pipelineName: `Infrastructure-Pipeline-${props.environment}`,
    });
