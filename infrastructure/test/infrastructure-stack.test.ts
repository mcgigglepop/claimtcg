...
describe('Testing Infrastructure code.', () => {
  ...
  test('The stack has a ECS cluster configured in the right way.', () => {
    ...
    const template = Template.fromStack(infrastructureStack9);
      ...
      ContainerDefinitions: [
        {
          ...
          LogConfiguration: {
            ...
            Options: {
              ...
              'awslogs-stream-prefix': Match.stringLikeRegexp('infrastructure'),
  ...
  it('Matches the snapshot.', () => {
    ...
    const infrastructureStack = new InfrastructureStack(stack, 'InfrastructureStack', {
      env: {
        region: parsed?.CDK_DEFAULT_REGION,
        account: parsed?.CDK_DEFAULT_ACCOUNT,
      },
