...
export default function TrendingProducts() {
  return (
    <section id="section-trending-projects" className="no-top no-bottom position-relative">
          <div className="container-fluid">
              <div className="row">
                  <div className="col-md-12 mt-100">
                      <div className="d-carousel">
                          <div id="item-carousel-big-type-4" className="owl-carousel owl-center" data-wow-delay="1s">
                              <div className="nft_pic mod-b">                            
                                  <a href="{{ url_for('main.index') }}">
                                      <span className="nft_pic_info">
                                          <span className="nft_pic_title">First Edition Charizard</span>
                              ...
                              <div className="nft_pic mod-b">                            
                                  <a href="{{ url_for('main.index') }}">
                                      <span className="nft_pic_info">
                                          <span className="nft_pic_title">Blue-Eyes White Dragon</span>
                                          <span className="nft_pic_by">PSA 10</span>
                                      </span>
                              ...
                              <div className="nft_pic mod-b">                            
                                  <a href="{{ url_for('main.index') }}">
                                      <span className="nft_pic_info">
                                          <span className="nft_pic_title">Legend of Blue-Eyes White Dragon</span>
                                          <span className="nft_pic_by">1st Edition Booster Box</span>
                                      </span>
                              ...
                              <div className="nft_pic mod-b">                            
                                  <a href="{{ url_for('main.index') }}">
                                      <span className="nft_pic_info">
                                          <span className="nft_pic_title">Family Event Trophy Kangaskhan</span>
                                          <span className="nft_pic_by">PSA 10</span>
                                      </span>
